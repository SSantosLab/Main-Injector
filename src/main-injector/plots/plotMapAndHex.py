...
from plots import mcbryde
from utils import hp2np, rotate, decam2hp
from skymaps import inside_footprint
...
def getDesFootprint () :
    ...
    ra, dec = inside_footprint.getFootprintRaDec() 
    return ra, dec

def getDesiFootprint (blob=1) :
    ra,dec = inside_footprint.getFootprintRaDec(blob) 
    return ra, dec
