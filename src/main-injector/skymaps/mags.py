...
import sky.atmosphere as atmosphere
from sky import telescope, dustModel, seeingModel, skyModel
from skymaps import mcbryde
...
class observed(object):
    ...
    def skyBrightness(self, zd, moon_zd, moon_sep, moon_phase, filter):
        ...
        sky = skyModel.sky_brightness_at_time(
...
def findNightDuration(mjd: float, camera="decam") -> Tuple[float, float, float]:
    """
    return
    """
    ctio_lat = -30.16527778
