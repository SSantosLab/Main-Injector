...
class DESGWApi:
    ...
    def add_trigger(self, trigger_data: dict) -> bool:
        ...
        ["trigger_label", "type", "ligo_prob", "far", "distance", "mjd", "event_datetime", "mock", "image_url"]

        :param trigger_data: a dictionary containing at minimum, trigger_label, event_datetime, and mock
        :return: True if successful, False otherwise
        """
        trigger_columns = [
            "trigger_label",
        ...
        required_columns = ["trigger_label", "event_datetime", "mock"]

        column_dtypes = [str, str, float, float, float, float, datetime, bool, str]
    ...
    def add_candidate(self, candidate_data: dict) -> bool:
        ...
        "redshift_final", "redshift_final_error", "host_galaxy_id"]

        :param candidate_data: a dictionary containing at minimum, candidate_label, event_datetime, and trigger_label
        :return: True if successful, False otherwise
        """
        candidate_columns = [
            "candidate_label",
    ...
    def add_candidate_object(self, object_data: dict) -> bool:
        """
        Add a new candidate object to the database.
        ...
        :param object_data: a dictionary containing at minimum, the candidate label
        :return: True if successful, False otherwise
        """
        object_columns = [
            "candidate_label",
        ...
        required_columns = ["candidate_label"]
