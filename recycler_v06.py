...
if __name__ == "__main__":
    ...
    if gw_id[0] == "S": #previouslt was 'alert_type[0]'
        EVENT_DIR = ROOT_DIR/"OUTPUT"/"O4REAL_test"/gw_id/alert_type #This will throw an error since there is PRELIMINARY_0 and PRELIMINARY_1
    ...
    if ("all" in options.stages) or ("rank-galaxies" in options.stages):
        ...
        catalog_path = EVENT_DIR/"initial_plots"
        find_galaxy_list(
    ...
    if ("all" in options.stages) or ("add-trigger" in options.stages):
        ...
        trigger_data = {
            ...
            "mock": False, # True for mock event, False for real event.
