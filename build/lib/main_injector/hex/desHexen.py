...
def cappedMolly():
    ...
    b_ix = n_era > 180
    n_era[b_ix] = n_era[b_ix]-360.
    b_ix = s_era > 180
    s_era[b_ix] = s_era[b_ix]-360.
...
def molly(do_not_too_close: bool =False):
    ...
    for i in zones:
        ...
        zone_ra, zone_dec = invSinProjection(
            hexenX, hexenY, lon_zero=zone_mid[i])
...
#
def euclideanHexen() -> Tuple[ArrayLike, ArrayLike]:
    """Return a Tuple of Arrays with RA and DEC for hexes"""
    xgap = 2.450
